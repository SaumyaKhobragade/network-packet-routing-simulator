...
function Topbar({ algorithm, setAlgorithm }: Props) {
  return (
    <header className="bg-gradient-to-r from-[#25331d]/80 via-[#1b2a3b]/80 to-[#0f1a2c]/80 border-b border-white/10 px-4 sm:px-6 py-4 backdrop-blur-xl shadow-lg">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-4 text-center md:flex-row md:items-center md:justify-between md:text-left">
        <div className="text-lg sm:text-xl font-semibold text-slate-100 tracking-wide">
